...
import { Image, StatusBar, StyleSheet, View, TouchableOpacity, Text } from "react-native";
...
export const StartScreen = ({ navigation }) => {
  ...
  return (
    <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} colors={["#a0defb", "#E0F0F8"]} style={st.ctn}>
      ...
      <View style={{ flex: 0.95, justifyContent: "space-between" }}>
        ...
        <View style={{ flex: 1, justifyContent: "space-between" }}>
          <View style={{ paddingVertical: 30, paddingHorizontal: 10, fontWeight: "700" }}>
            <Text style={st.txtHdr}>Welcome</Text>
            <Text style={st.txt}>To moi university app farm managemeemnt application </Text>
          </View>
...
const st = StyleSheet.create({
  ...
  buttons: { backgroundColor: "#50C878", borderRadius: 10, paddingVertical: 10 },
